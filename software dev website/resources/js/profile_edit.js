function openEdit() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        var upperCaseLetters = /[A-Z\s]+/g; // : Fill in the regular experssion for upperCaseLetters
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (myInput.value.match(confirmMyInput)); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (letter.enabled && capital.enabled && number.enabled && length && enabled && match.enabled); // TODO: Replace false with the correct condition
    if(!condition) {       
